...
const Navbar = () => {
  ...
  return (
    <nav id="navbar" className=" bg-[#0F172A] fixed top-0 left-0 min-w-full z-50 backdrop-blur-lg ">
      ...
      {open && (
        <ul className="md:hidden  text-[#CBD5E1] shadow-md flex flex-col items-center py-4 gap-4">
          <li><a onClick={() => setOpen(false)} href="#about"     className="hover:text-[#3B82F6]">About</a></li>
          <li><a onClick={() => setOpen(false)} href="#services"  className="hover:text-[#3B82F6]">Services</a></li>
          <li><a onClick={() => setOpen(false)} href="#portfolio" className="hover:text-[#3B82F6]">Portfolio</a></li>
